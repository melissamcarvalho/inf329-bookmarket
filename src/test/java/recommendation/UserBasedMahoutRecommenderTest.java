...
/**
 * Test class for UserBasedMahoutRecommender
 *
 */
public class UserBasedMahoutRecommenderTest {
    ...
    public void setUp() throws Exception {
        ...
        // All these users, have similar preferences, and the ONLY option is to recommend what is MISSING
        ...
        org.apache.mahout.cf.taste.impl.common.FastByIDMap<PreferenceArray> userData = 
            new org.apache.mahout.cf.taste.impl.common.FastByIDMap<PreferenceArray>();
    ...
    /**
     * Test default neighborhood initialization
     */
    @Test
    ...
    /**
     * Test custom neighborhood setting
     */
    @Test
    ...
    /**
     * Test neighborhood size getter and setter
     */
    @Test
     ...
     * Mahout handles non-existent users gracefully by returning empty list
     */
    @Test
    public void testRecommendWithNonExistentUser() {
        // User ID 999 doesn't exist in our data model
        List<Integer> recommendations = recommender.recommend(999, 1);
        
        // Mahout returns an empty list for non-existent users
        assertTrue("Should return empty list for non-existent user", recommendations.isEmpty());
    }
